...
public class Beacon extends Action {
	...
	public void add(Mapper context, Position pos, Block block) {
		...
		Cuboid beacon = context.createCuboid(pos, end, pixels, startOffset, endOffset, block);
		beacon.setSkin(this.constructSkin(block));
		context.addDetail(beacon);
	}
